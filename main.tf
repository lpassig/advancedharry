...
# Use module lz to create a landing zone
module "lz" {
...
module "ec2-instance" {
  ...
  availability_zone           = module.lz.availability_zone
  monitoring                  = true
  vpc_security_group_ids      = module.lz.vpc_security_group_ids
  subnet_id                   = module.lz.subnet_id
  associate_public_ip_address = true
  iam_instance_profile        = module.lz.instance_profile
